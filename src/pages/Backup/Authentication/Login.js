                                        ...
                                        <Row className="justify-content-center">
                                            <Col lg={9}>
                                                <div>
                                                    ...
                                                    <div>
                                                        <Link to="/" class="">
                                                            <img src={logodark} alt="" class="auth-logo logo-dark mx-auto" />
                                                            <img src={logolight} alt="" class="auth-logo logo-light mx-auto" />
                                                        </Link>
                                                    </div>

                                                        <h4 className="font-size-18 mt-4">Welcome Back !</h4>
                                                        <p className="text-muted">Sign in to continue to CoinFiz.</p>
                                                    </div>
