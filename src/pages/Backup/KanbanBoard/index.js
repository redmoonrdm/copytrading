                                    ...
                                    <ul className="list-inline mb-0">
                                        <li className="list-inline-item">
                                            <Link to="#" className="d-inline-block" id="member1">
                                                <img src={avatar2} className="rounded-circle avatar-xs" alt="CoinFiz" />
                                            </Link>
                                        ...
                                        <li className="list-inline-item">
                                            <Link to="#" className="d-inline-block" id="member3">
                                                <img src={avatar4} className="rounded-circle avatar-xs" alt="CoinFiz" />
                                            </Link>
